  ...
  module.exports = {
    go: function() {
      return function(scope, elem, props) {
        ...
        return scope.$on('teardown', function() {
          return elem.removeEventListener('mousedown', listener);
        });
      };
    },
    hide: function() {
    ...
    press: function(app) {
      return function(scope, elem, props) {
        ...
        if (/\(/.test(props.press)) {
          listener = function(event) {
            console.log('pressed');
            return app.$eval(props.press, scope);
          };
        } else {
      ...
      return function(scope, elem, props) {
        ...
        setValue = function() {
          if (elem.value !== app.$eval(props.model)) {
            return elem.value = app.$eval(props.model, scope);
          }
        };
        setValue();
        ...
        scope.$on('teardown', function() {
          return elem.removeEventListener('keyup', updateModel);
        });
